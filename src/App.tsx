...
export default function App() {
  ...
  return (
    <div id="root-viewport" className="min-h-screen bg-slate-900 font-sans text-slate-100 antialiased p-4 md:p-8 selection:bg-amber-500 selection:text-slate-900">
      ...
      */}
      <header id="dashboard-header" className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between border-b border-slate-800 pb-5 mb-8">
        <div className="flex items-center gap-4 mb-4 md:mb-0">
          <div className="p-3 bg-gradient-to-tr from-amber-600 to-amber-500 rounded-xl shadow-lg ring-2 ring-amber-500/20">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <button 
            ...
            className={`px-3 py-1.5 rounded-lg border text-xs flex items-center gap-1.5 transition-all outline-none ${
              soundEnabled 
          ...
          >
            {soundEnabled ? (
              ...
              <>
                ...
                <span>Sound Alerts: Mutated</span>
              </>
            )}
          </button>
        </div>
